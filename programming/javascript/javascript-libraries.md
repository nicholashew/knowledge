...
* [Package Managers](javascript-libraries.md#package-managers)
* [Loaders](javascript-libraries.md#loaders)
* [Bundlers](javascript-libraries.md#bundlers)
* [Testing Frameworks](javascript-libraries.md#testing-frameworks)
* [QA Tools](javascript-libraries.md#qa-tools)
* [MVC Frameworks and Libraries](javascript-libraries.md#mvc-frameworks-and-libraries)
* [Node-Powered CMS Frameworks](javascript-libraries.md#node-powered-cms-frameworks)
* [Templating Engines](javascript-libraries.md#templating-engines)
* [Articles/Posts](javascript-libraries.md#articles-and-posts)
* [Data Visualization](javascript-libraries.md#data-visualization)
  * [Timeline](javascript-libraries.md#timeline)
  * [Spreadsheet](javascript-libraries.md#spreadsheet)
* [Editors](javascript-libraries.md#editors)
* [Documentation](javascript-libraries.md#documentation)
* Utilities
  * [Files](javascript-libraries.md#files)
  * [Functional Programming](javascript-libraries.md#functional-programming)
  * [Reactive Programming](javascript-libraries.md#reactive-programming)
  * [Data Structure](javascript-libraries.md#data-structure)
  * [Date](javascript-libraries.md#date)
  * [String](javascript-libraries.md#string)
  * [Number](javascript-libraries.md#number)
  * [Storage](javascript-libraries.md#storage)
  * [Color](javascript-libraries.md#color)
  * [I18n And L10n](javascript-libraries.md#i18n-and-l10n)
  * [Control Flow](javascript-libraries.md#control-flow)
  * [Routing](javascript-libraries.md#routing)
  * [Security](javascript-libraries.md#security)
  * [Log](javascript-libraries.md#log)
  * [RegExp](javascript-libraries.md#regexp)
  * [Media](javascript-libraries.md#media)
  * [Voice Command](javascript-libraries.md#voice-command)
  * [API](javascript-libraries.md#api)
  * [Streaming](javascript-libraries.md#streaming)
  * [Vision Detection](javascript-libraries.md#vision-detection)
  * [Browser Detection](javascript-libraries.md#browser-detection)
  * [Benchmark](javascript-libraries.md#benchmark)
  * [Machine Learning](javascript-libraries.md#machine-learning)
* UI
  * [Code Highlighting](javascript-libraries.md#code-highlighting)
  * [Loading Status](javascript-libraries.md#loading-status)
  * [Validation](javascript-libraries.md#validation)
  * [Keyboard Wrappers](javascript-libraries.md#keyboard-wrappers)
  * [Tours And Guides](javascript-libraries.md#tours-and-guides)
  * [Notifications](javascript-libraries.md#notifications)
  * [Sliders](javascript-libraries.md#sliders)
  * [Range Sliders](javascript-libraries.md#range-sliders)
  * [Form Widgets](javascript-libraries.md#form-widgets)
  * [Tips](javascript-libraries.md#tips)
  * [Modals and Popups](javascript-libraries.md#modals-and-popups)
  * [Scroll](javascript-libraries.md#scroll)
  * [Menu](javascript-libraries.md#menu)
  * [Table/Grid](javascript-libraries.md#tablegrid)
  * [Frameworks](javascript-libraries.md#frameworks-1)
  * [Boilerplates](javascript-libraries.md#boilerplates)
* [Gesture](javascript-libraries.md#gesture)
* [Maps](javascript-libraries.md#maps)
* [Typography](javascript-libraries.md#typography)
* [Animations](javascript-libraries.md#animations)
* [Image processing](javascript-libraries.md#image-processing)
* [ES6](javascript-libraries.md#es6)
* [SDK](javascript-libraries.md#sdk)
* [Misc](javascript-libraries.md#misc)
* [Podcasts](javascript-libraries.md#podcasts)
* [Worth Reading](javascript-libraries.md#worth-reading)
...
* [cypress](https://www.cypress.io/) - A complete end-to-end testing experience.
...
* [jquery](https://jquery.com/) - Makes things like HTML document traversal and manipulation, event handling, and Ajax much simpler.
...
* [mustache.js](https://github.com/janl/mustache.js) - Minimal templating with  in JavaScript.
...
* [html5media](https://github.com/etianen/html5media) -  Enables `<video>` and `<audio>` tags in all major browsers. [https://html5media.info/](https://html5media.info/)
...
* [mediaelement](https://github.com/johndyer/mediaelement) -  HTML5 `<audio>` or `<video>` player with Flash and Silverlight shims that mimics the HTML5 MediaElement API, enabling a consistent UI in all browsers. [http://mediaelementjs.com/](http://mediaelementjs.com/)
...
* [shuffle-images](https://github.com/peachananr/shuffle-images) -  The Simplest Way to shuffle through images in a Creative Way [http://www.thepetedesign.com/demos/shuffle-images\_demo.html](http://www.thepetedesign.com/demos/shuffle-images_demo.html)
* [smoothState.js](https://github.com/miguel-perez/smoothState.js) - Unobtrusive page transitions with jQuery. [http://smoothstate.com/](http://smoothstate.com/)
...
* [survey.js](https://github.com/surveyjs/surveyjs) - JavaScript Survey Engine. It uses JSON for survey metadata and results. [http://surveyjs.org/](http://surveyjs.org/)
...
* [YDKJS](https://github.com/getify/You-Dont-Know-JS) - You Don't Know JS \(book series\).
...
> Author: [cedrickchee](https://cedrickchee.gitbook.io/knowledge/programming-languages/programming-languages/javascript/js-libraries) Content: [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/) License [MIT](https://cedrickchee.mit-license.org/)
